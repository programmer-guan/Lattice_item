...
/* Module Version: 5.7 */
/* F:\software\3_11_Diamond_x64\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL_75M -lang verilog -synth lse -arch xo2c00 -type pll -fin 30 -fclkop 75 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Wed Nov 06 20:26:47 2019 */


`timescale 1 ns / 1 ps
module PLL_75M (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
